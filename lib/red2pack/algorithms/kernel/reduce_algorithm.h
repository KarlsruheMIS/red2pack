...
#include "red2pack/algorithms/kernel/reductions.h"
#include "red2pack/data_structure/m2s_dynamic_graph.h"
...
class reduce_algorithm : public Ireduce_algorithm{
       public:
       ...
       public:
        ...
        void build_solution(std::vector<bool> &solution_vec);

        NodeWeight get_solution_weight() const;

        void get_exact_kernel(m2s_graph_access& reduced_graph, std::vector<NodeID>& reduced_node_id, std::vector<NodeID>& former_node_id);

...
int parse_parameters(int argn, char **argv, two_packing_set::M2SConfig &m2s_config, MISConfig &mis_config, std::string &graph_filepath) {
        ...
        struct arg_str *reduction_style2 =
            arg_str0(NULL, "reduction_style2", NULL, "Choose between elaborated and core.");
        ...
        struct arg_lit *on_demand_two_neighborhood = arg_lit0(NULL, "on_demand_two_neighborhood", "on demand two neighborhood");
        ...
        void *argtable[] = {help, filename, output, user_seed,
                            ...
                            reduction_style2, reduction_style, kernel_file_name, console_log, time_limit,
                            end};

...
#ifndef _m2pack_log_H_
#define _m2pack_log_H_
...
class m2pack_log {
    public:
         ...
         */
        static m2pack_log *instance() {
            static m2pack_log inst;
            return &inst;
        };
         ...
         */
        void set_graph(M2S_GRAPH::graph_access & G);
         ...
         */
        void print_round(M2SConfig & m2s_config);
         ...
         * @param m2s_config Config for the logger.
         */
        void print_repetition(M2SConfig & m2s_config);
         ...
         */
        void set_best_size_online(M2SConfig & m2s_config, unsigned int size);
         ...
         * @param size Candidate to replace the best solution size.
         */
        void set_best_size(M2SConfig & m2s_config, unsigned int size);

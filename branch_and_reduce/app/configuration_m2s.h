...
#ifndef _CONFIGURATION_M2S_H_
#define _CONFIGURATION_M2S_H_
...
class configuration_m2s {
    public:
         ...
         */
        void standard( M2SConfig & config );
         ...
         * @param config Config to be initialized.
         */
        void full_standard( M2SConfig & config );
         ...
         * @param config Config to be initialized.
         */
        void full_social( M2SConfig & config );
};

inline void configuration_m2s::standard( M2SConfig & m2s_config ) {
    // Basic 
    ...
    m2s_config.reduction_style2                       = M2SConfig::Reduction_Style2::initial;
    // Convergence
...
inline void configuration_m2s::social( M2SConfig & m2s_config ) {
    standard(m2s_config);
    m2s_config.kahip_mode                             = FASTSOCIAL;
}

inline void configuration_m2s::full_standard( M2SConfig & m2s_config ) {
    standard(m2s_config);
...
inline void configuration_m2s::full_social( M2SConfig & m2s_config ) {

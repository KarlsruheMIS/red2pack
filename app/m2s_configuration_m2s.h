...
class m2s_configuration_m2s {
       public:
         ...
         */
        void standard(red2pack::M2SConfig &config);
         ...
         * @param config Config to be initialized.
         */
        void social(red2pack::M2SConfig &config);
         ...
         * @param config Config to be initialized.
         */
        void full_standard(red2pack::M2SConfig &config);
         ...
         * @param config Config to be initialized.
         */
        void full_social(red2pack::M2SConfig &config);
};

inline void m2s_configuration_m2s::standard(red2pack::M2SConfig &m2s_config) {
        // Basic
